...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/02/09 16:55:25 by asabbar           #+#    #+#             */
/*   Updated: 2022/02/23 09:28:04 by asabbar          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	put_image_bounus(t_var *move, int i, int j);
...
void	ft_xpm_to_image(t_var mouve);
void	put_img_bonus(t_var *move);
void	ft_exit(void);
void	ft_count(t_var *move);
void	ft_count_m(t_var *move);
void	ft_win(void);
int		checkpy(char **s);
int		checkpx(char **s);
int		checkpe(char **s);
void	move_anima(t_var *move);
void	ft_freexit2(char **s, char *str);
void	ft_freexit(char *str);
void	ft_freexit(char *str);
void	ft_freexit2(char **s, char *str);
int		a_check(char **s);
int		move_wb(t_var *move, int i, int j);
int		move_sb(t_var *move, int i, int j);
int		move_db(t_var *move, int i, int j);
int		move_ab(t_var *move, int i, int j);
